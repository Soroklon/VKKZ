...
%if cS:
        <hr>
        <span class="fs-5" style="font-weight: bold; margin-bottom: 0.5cm;">На {{tFrom}}</span>
%end      
...
%if cS:       
          <section class="sticky2 bg-light">
            ...
            <span class="fs-5" style="font-weight: bold; margin-bottom: 0.5cm;">Суммарно в системе</span>
            <table style="width: 1450px; background-color:#212529; color:#ffffff">
              <tr>
                <th style="width: 5cm; text-align: left;">Код</th>
                <th style="width: 8cm; text-align: left;">Наименование</th>
                <th style="width: 14cm; text-align: left;">Вес</th>
              </tr>
            </table>
          </section>
          ...
          <div class="accordion-item" style="width: 1450px">
              <h2 class="accordion-header" id="panelsStayOpen-heading{{i}}">
                <button id="panelsStayOpen-btn{{i}}" class="accordion-button collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#panelsStayOpen-collapse{{i}}" aria-expanded="false" aria-controls="panelsStayOpen-collapse{{i}}" style="height: 30px">
                  <table>
                    <tr>
                      <th style="width: 6.5cm; font-weight: normal; color:black">{{r}}</th>
                    </tr>
                  </table>
                </button>
              </h2>
