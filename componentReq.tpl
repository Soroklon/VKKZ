            ...
            <tr>
              ...
              <th style="width:50%; text-align: right;">
                <button type="button" id="hideAllBtn" onclick="expandAll()"  data-bs-toggle="tooltip" data-bs-placement="bottom" title="Развернуть все" class="btn btn-light" style="width: 40px; align-self:flex-start ; margin-bottom: 0cm; margin-right: 0.1cm; align-self: flex-end;">
                  <img src="assets/dist/img/expand_lay.png" style="width: 10px; height: 25px; align: center;" alt="скрыть все"></button>
                <button type="button" id="hideAllBtn" onclick="hideAll()" data-bs-toggle="tooltip" data-bs-placement="bottom" title="Свернуть все" class="btn btn-light" style="width: 40px; margin-bottom: 0cm; margin-right: 0.1cm; align-self: flex-end;">
                  <img src="assets/dist/img/collapse_lay.png" style="width: 10px; height: 25px; align: center;" alt="скрыть все"></button>
                <button type="submit" id="DownloadBtn" onclick="window.location = '{{rName}}'" data-bs-toggle="tooltip" data-bs-placement="bottom" title="Сохранить" class="btn btn-light" style="width: 60px; margin-bottom: 0cm; margin-right: 0.1cm; align-self: center">
        ...
        <section class="sticky1 bg-light">
          ...
          <table style="width: 1450px; background-color:#212529; color:#ffffff">
            <tr>
              ...
              <th style="width: 6cm; text-align: left;">Приход</th>
              <th style="width: 6cm; text-align: left;">Расход</th>
              <th style="width: 7cm; text-align: left;"></th>
            </tr>
          </table>
        </section>
 
        <div class="accordion accordion-flush" id="accordionComponents" style="width: 1450px;>
%i = 0
%for r in ct:
...
%for c in cl[i]:
                  <tr>
                    <th style="width: 6.5cm; font-weight: normal; color:black"></th>
                    <th style="width: 11.5cm; font-weight: normal; color:black"></th>
                    <th style="width: 6.3cm; font-weight: bold; color:darkblue">
%if c[0] != 0:
                    {{c[0]}}
%else:
                    -
%end
                    ...
                    <th style="width: 6.3cm; font-weight: bold; color:darkgreen">
%if c[1] != 0:
                    {{c[1]}}
%else:                    
                    -
%end                    
                    ...
                    <th id="timeStmp{{i}}{{j}}" style="width: 5cm; font-weight: bold;">{{c[2]}}</th>
                  </tr>
%j = j + 1
%end
                </table>
